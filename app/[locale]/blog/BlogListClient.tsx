...
interface Props {
  posts: BlogPost[];
  locale: "sr-Latn" | "sr" | "en";
  labels: { title: string; subtitle: string; readMore: string };
}

export function BlogListClient({ posts, locale, labels }: Props) {
  return (
      ...
      <section className="py-24 px-4">
        <div className="max-w-7xl mx-auto">
          <div className="mb-16">
            ...
            <p className="text-xl text-white-text-muted max-w-2xl">{labels.subtitle}</p>
          </div>
